...
This is a fork of Mean.js for hashid integration. In progress!
...
* Hashid - Take a tour at [hashids - node.js](http://hashids.org/node-js/). Hash your url-exposed variables.
